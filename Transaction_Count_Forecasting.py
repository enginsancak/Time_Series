...
# A forecast of the total transaction volume by merchant_id and daily basis is expected for the last 3 months of 2020.

###############################################################
# Dataset Story
###############################################################
#  The data includes information from 7 member businesses from 2018 to 2020.
